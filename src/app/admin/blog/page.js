      ...
      <header className="bg-white border-b p-4 sticky top-0 z-10 shadow-sm flex items-center justify-between">
        <div className="flex items-center gap-3">
          <a href="https://www.ssagesage.com/" className="flex items-center gap-2">
            ...
            <span className="text-lg font-bold text-gray-800">싸게사게</span>
          </a>
      ...
      <main className="p-4 flex flex-col gap-4">
        ...
        {!loading && posts.length === 0 && (
          <div className="bg-white rounded-2xl shadow-sm border border-gray-100 text-center py-16">
            ...
            {/* ✅ 새 글 작성하기 버튼으로 변경 */}
            <button onClick={() => router.push('/admin/blog/editor')} className="px-4 py-2 bg-blue-50 text-blue-600 rounded-xl font-medium hover:bg-blue-100 transition-colors inline-block">
              새 글 작성하기
            </button>
          </div>
        )}
